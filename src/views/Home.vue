<template>
    <v-container fluid fill-height>
        <v-layout text-md-center wrap justify-center align-start>
            ...
            <v-flex class="order-md-2 bt-md-1">
                <v-card class="info info ml-md-1 mb-2 mb-md-0" style="background-color: white !important;">
            ...
            <v-flex md5 sm12 class="order-md-1 bt-md-1">
                <v-card class="calendar mr-md-1 pl-md-2 pr-md-2 pb-8">
                    <MiniCalendar class="mx-1" style="height: 38vh;" />
                </v-card>
            </v-flex>

            <v-flex md11 class="order-md-last mt-3">
                <v-card dark>
